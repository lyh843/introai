...
def readCommand(argv):
    ...
    # Special handling for mixed ghost types
    if options.ghost == 'MixedGhosts':
        from mixedGhostAgents import MixedGhostManager
        args['ghosts'] = MixedGhostManager.createMixedGhosts(options.numGhosts)
    else:
